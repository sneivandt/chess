...
// Passed pawn score
const std::array<int, 8> PASSED_PAWN = {0, 5, 10, 20, 35, 60, 100, 200};
...
// Piece square tables
const std::array<std::array<int, 64>, 7> PIECE_SQUARE_TABLE = {
    {{},
     {// Pawn
...
const std::array<int, 64> PIECE_SQUARE_TABLE_KING_OPENING = {
...
// Piece square table king opening
const std::array<int, 64> PIECE_SQUARE_TABLE_KING_END = {
    -50, -10, 0,  0,  0,   0,  -10, -50, -10, 0,  10, 10,  10,  10,  0,  -10, 0,  10, 15,  15, 15, 15,
    10,  0,   0,  10, 15,  20, 20,  15,  10,  0,  0,  10,  15,  20,  20, 15,  10, 0,  0,   10, 15, 15,
    15,  15,  10, 0,  -10, 0,  10,  10,  10,  10, 0,  -10, -50, -10, 0,  0,   0,  0,  -10, -50};

// Mirror a piece square table index
const std::array<int, 64> MIRROR_PIECE_SQUARE_TABLE = {56, 57, 58, 59, 60, 61, 62, 63, 48, 49, 50, 51, 52, 53, 54, 55,
